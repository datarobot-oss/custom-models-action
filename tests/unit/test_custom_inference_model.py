...
class TestGlobPatterns:
    ...
    def test_filtered_model_paths(
        self, included_paths, excluded_paths, expected_num_model_files, options_factory
    ):
        model_info = ModelInfo("yaml-path", "/m", None)
        with patch("common.git_tool.Repo.init"), patch("custom_inference_model.DrClient"):
            custom_inference_model = CustomInferenceModel(options_factory("/"))
            custom_inference_model._set_filtered_model_paths(
